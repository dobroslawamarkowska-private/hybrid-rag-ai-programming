...
- **API calls:** 3
- **Detail:** Vector search for 3 queries, 15 docs after dedup

### Step 3: check_and_refine
- **Model:** openai/gpt-5.2
- **API calls:** 1
- **Detail:** Grader score 0.45 < 0.5, refined query for retry
...
- **Model:** -
- **API calls:** 0
- **Detail:** Built context from 6 chunks (6872 chars)
